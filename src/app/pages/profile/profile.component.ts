...
@Component({
  ...
  imports: [CommonModule, FormsModule, ReactiveFormsModule, HeaderComponent, NavigationBarComponent, MapAddressComponent, ManageCardsComponent, ManageBanksComponent, ProfileImageComponent],
