...
import { DiplomaStatus, User } from '../../models/user';
...
@Component({
  ...
  imports: [CommonModule, FormsModule, HeaderComponent, NavigationBarComponent, MapAddressComponent, ManageCardsComponent, ProfileImageComponent],
...
export class ProfileComponent {
  ...
  setPaymentPreference(preference: string): void {
